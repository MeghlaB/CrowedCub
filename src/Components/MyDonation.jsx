    ...
    <div>
      {
        userCampaigns.length === 0 ? (
          ...
          <p className="text-center flex justify-center items-center  text-2xl font-bold text-violet-700 text-gray-500  bg-base-200 h-80 my-7 mx-7">No donations found!</p>
        ) 
        :(
