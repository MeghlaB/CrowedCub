...
//       <div className=" min-h-screen hero bg-gradient-to-r flex items-center justify-center">
//         <div className="hero-content flex-col lg:flex-row-reverse items-center gap-10 w-full max-w-6xl">
//           {/* Image Section */}
//           <div className={`text-center lg:text-left lg:w-1/2 p-8 rounded-lg transition-all duration-300 ${theme === 'dark' ? 'bg-[#1F2937]' : ''}`}>
  ...
  return (
    <div className={theme === 'dark' ? 'dark' : ''}>
      <div className="hero bg-gradient-to-r min-h-screen flex items-center justify-center">
        <div className="hero-content flex-col lg:flex-row-reverse items-center gap-10 w-full max-w-6xl">
          {/* Image Section */}
          <div className={`text-center lg:text-left lg:w-1/2 p-8 rounded-lg transition-all duration-300 ${theme === 'dark' ? 'bg-gray-800' : ''}`}>
            <h1 className={`text-3xl font-bold mb-6 text-center transition-colors ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
              Welcome Back!
            </h1>
            <img
